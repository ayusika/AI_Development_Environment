...
$requestData = [
    ...
    'instructions' =>
        ...
        . '接客メモは素材です。そのままコピーして返してはいけません。'
        . '必ず接客メモを自然な写メ日記の文章へ書き直してください。'
        . '箇条書きやメモ口調ではなく、お客様本人に話しかけるようなお礼文にしてください。'
        . '接客メモが短くても、事実を創作しない範囲で文章として自然につないでください。'
        . '追加指示に「短め」「甘め」などがあれば、文章量や雰囲気にはっきり反映してください。'
        . '絵文字や♡は文章に自然な範囲で少量使用して構いません。'
        . 'タイトルは作らないでください。'
